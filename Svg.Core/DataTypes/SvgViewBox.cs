...
namespace Svg
{
    ...
    public struct SvgViewBox
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SvgSetup.SvgViewBox"/> to <see cref="Svg.Interfaces.RectangleF"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Svg.Interfaces.RectangleF"/> to <see cref="SvgSetup.SvgViewBox"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
