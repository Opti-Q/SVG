...
namespace Svg.Collections.Generic
{
    using System;
        ...
        IDictionary<TKey, TValue>, System.Collections.IDictionary
    {
        ...
        void System.Collections.ICollection.CopyTo(Array array, int arrayIndex)
        {
            ...
            if (array.Rank != 1)
            {
                throw new ArgumentException(nameof(array) + " rang must be 1");
            }
            ...
            else
            {
                ...
                if (objects == null)
                {
                    ...
                    throw new ArgumentException(nameof(array) + " is of invalid type");
                }
                ...
                {
                    //ThrowHelper.ThrowArgumentException(ExceptionResource.Argument_InvalidArrayType);
                    throw new ArgumentException(nameof(array) + " has invalid element types");
                }
        ...
        private sealed class KeyList : IList<TKey>, System.Collections.ICollection
        {
            ...
            void System.Collections.ICollection.CopyTo(Array array, int arrayIndex)
            {
                if (array != null && array.Rank != 1)
                    ...
                    throw new ArgumentException(nameof(array) + " Arg_RankMultiDimNotSupported");
